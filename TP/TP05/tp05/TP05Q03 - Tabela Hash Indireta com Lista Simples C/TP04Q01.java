...
class ArvoreBinaria{
	...
	private No remover(String nomePlayer, No i){
		...
		} else if(i.elemento.getNome().compareTo(nomePlayer) > 0){
...
public class TP04Q01{
	 ...
	 */
	private static void getSegundaEntrada(ArvoreBinaria tree, RecordAlgoritmo record){
		String input = "";
	...
	public static void main(String []arg){
		RecordAlgoritmo record = new RecordAlgoritmo("699415_arvoreBinaria.txt");
